  ...
  <div class="container-fluid">
    ...
    <div class="nav justify-content-center" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <br>
    <div class>
        <a href="tambah_data_ibuhamil.php" button class="btn btn-outline-primary"  type="button"><i class="fa-solid fa-plus"><b></i> TAMBAH DATA PEMERIKSAAN IBU </b></i></a>
        <a href="cetak_laporan_data_ibuhamil.php" button class="btn btn-outline-primary"  type="button" > <i class="fa-solid fa-print"></i><b> CETAK LAPORAN PEMERIKSAAN IBU </b></i></a>
    </div><br>
        <!-- untuk mengeluarkan data -->
        <div class="card">
            <div class="card-header text-white bg-primary">
                <b>DATA PEMERIKSAAN IBU HAMIL</b>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Usia Kandungan (Minggu)</th>
                            <th scope="col">Tinggi Fundus (CM)</th>
                            <th scope="col">Denyut Jantung Janin (BPM)</th>
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from data_ibu_hamil order by id desc";
                        ...
                        while ($r2 = mysqli_fetch_array($q2)) {
                            ...
                            $umur_ibu       = $r2['umur_ibu'];
                            $berat_badan    = $r2['berat_badan'];
                            $tinggi_badan   = $r2['tinggi_badan'];
                            $tekanan_darah  = $r2['tekanan_darah'];
                            $usia_kandungan = $r2['usia_kandungan'];
                            $tinggi_fundus  = $r2['tinggi_fundus'];
                            $denyut_janin   = $r2['denyut_janin'];
                            $keluhan        = $r2['keluhan'];
                            $saran   = $r2['saran'];
                        ?>
                            <tr>
                                ...
                                <td scope="row"><?php echo $umur_ibu ?></td>
                                <td scope="row"><?php echo $berat_badan ?></td>
                                <td scope="row"><?php echo $tinggi_badan ?></td>
                                <td scope="row"><?php echo $tekanan_darah ?></td>
                                <td scope="row"><?php echo $usia_kandungan ?></td>
                                <td scope="row"><?php echo $tinggi_fundus ?></td>
                                <td scope="row"><?php echo $denyut_janin ?></td>
                                <td scope="row"><?php echo $keluhan ?></td>
                                <td scope="row"><?php echo $saran ?></td>
                                <td scope="row">
                                    <a href="tambah_data_ibuhamil.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                    <a href="tambah_data_ibuhamil.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a>            
                                </td>
                            </tr>
                        <?php
                        }
