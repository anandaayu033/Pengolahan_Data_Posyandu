  ...
  <div class="container-fluid">
    ...
    <div class="nav justify-content-center" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <br>
    <div class>
        <a href="tambah_identitas.php" button class="btn btn-outline-primary"  type="button"><i class="fa-solid fa-plus"><b></i>TAMBAH DATA IDENTITAS </b></i></a>
        <a href="cetak.php" button class="btn btn-outline-primary"  type="button" > <i class="fa-solid fa-print"></i><b> CETAK LAPORAN IDENTITAS </b></i></a>
    </div><br>
    <div class>
        <!-- untuk mengeluarkan data -->
        <div class="card">
            <div class="card-header bg-black bg-light">
            <h3><b>DATA IDENTITAS ANAK</b></h3>
            </div>
            <div class="card-body">
                <table class="table">
                    <thead>
                    ...
                    <tbody>
                        <?php
                        $sql2   = "select * from anak order by id desc";
                        ...
                        ?>
                            <tr>
                                ...
                                <td scope="row"><?php echo $ibu ?></td>
                                <td scope="row"><?php echo $ayah ?></td>
                                <td scope="row"><?php echo $perayah ?></td>
                                <td scope="row">
                                    <a href="tambah_identitas.php?op=edit&id=<?php echo $id ?>"><button type="button" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></button></a>
                                    <a href="tambah_identitas.php?op=delete&id=<?php echo $id?>" onclick="return confirm('Yakin mau delete data?')"><button type="button" class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a>            
                                </td>
                            </tr>
                        <?php
                        }
